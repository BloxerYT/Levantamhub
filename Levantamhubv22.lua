if game:GetService("CoreGui"):FindFirstChild("LeVanTam GUI") then
	game:GetService("CoreGui"):FindFirstChild("LeVanTam GUI"):Destroy()
end
local DiscordLib = {}
...
function DiscordLib:Window(text,mainclr,cls)
	local PresetColor = mainclr or Color3.fromRGB(255,51,51) or _G.Color
	...
	function DiscordLib:Notification(titletext, desctext, btntext)
		...
		AlrightBtn.Font = Enum.Font.SciFi
	...
	function ServerHold:Server(text, img)
		...
		ServerTitle.Font = Enum.Font.SciFi
		...
		TimeGlobal.ZIndex = 3
		TimeGlobal.Font = Enum.Font.SciFi
		...
		ChannelTitle.Font = Enum.Font.SciFi
		ChannelTitle.Text = ""
		...
		function ChannelHold:Channel(text,ico)
			...
			ChannelBtnTitle.Font = Enum.Font.SciFi
			...
			function ChannelContent:Dropdown(text, list, callback)
				...
				DropdownTitle.Font = Enum.Font.SciFi
				DropdownTitle.Text = ""
				...
				CurrentSelectedText.Font = Enum.Font.SciFi
				...
				DropItemHolderLabel.Font = Enum.Font.SciFi
			...
			function ChannelContent:Colorpicker(text, preset, callback)
				...
				ColorpickerTitle.Font = Enum.Font.SciFi
			...
			function ChannelContent:Textbox(text, placetext, disapper, callback)
				...
				TextboxTitle.Font = Enum.Font.SciFi
			...
			function ChannelContent:Bind(text, presetbind, callback)
				...
				KeybindTitle.Font = Enum.Font.SciFi
				...
				KeybindText.Font = Enum.Font.SciFi
...
local serv = win:Server("ZEN HUB","")

local AutoFarm = serv:Channel("Main")
